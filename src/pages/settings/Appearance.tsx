...
function PresetTheme({ name, theme }: { name: string, theme: Theme }) {
  ...
  return (
    <div class="flex flex-col items-center w-full max-w-[512px] cursor-pointer group" onClick={() => setTheme(theme, true)}>
      <div classList={{
...
export default function Appearance() {
  ...
  return (
    <SettingsLayout title="Appearance">
      <div class="flex flex-col w-full h-[calc(100%-3.5rem)] overflow-y-auto">
        <h2 class="font-bold px-4 pt-4 pb-2 text-fg/50 mobile:text-center">Preset Themes</h2>
        <div class="flex gap-4 mx-4 mobile:flex-col">
