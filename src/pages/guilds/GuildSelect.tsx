  ...
  return (
    <Layout showBottomNav>
      ...
      <div class="flex flex-col w-full h-full">
        ...
        <button
          class="absolute top-3 right-3 flex group items-center justify-center bg-3 border-4
            border-bg-2 hover:bg-accent rounded-[50%] hover:rounded-[25%] transition-all duration-300 w-12 h-12"
        ...
        >
          <Icon
            icon={Plus}
            title="New Server"
            class="fill-accent-light group-hover:fill-fg select-none w-5 h-5"
          />
        </button>
      </div>
    </Layout>
